...
## 5. Tone of Code
- Keep code concise, modern (Kotlin-first), and consistent with existing patterns.
- Add descriptive logging (Logcat) for hardware parsing to assist in remote debugging.
